...
def parse_args():
    parser = argparse.ArgumentParser(description="Gemma-3-12B Inference Test")
...
def main():
    ...
    for local_idx, seed in enumerate(target_seeds):
        ...
        if exp_type_idx == 0:
            ...
            output_path = f"subject_data/gemma3/12b/experiment_list_{subject_id}.csv"
            target_csv = bas_path
            is_bas = True
        elif exp_type_idx == 1:
        ...
        try:
            ...
            output_filename = f"results/gemma3/12b/result_{subject_id}.csv"
